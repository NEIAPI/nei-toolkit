...
pro._diff = function (oldData, newData) {
    ...
    var getDescExp = function (options, noSuffix) {
        ...
        var str = util.format(
            ...
            options.name,
            options.dataName ? util.format('(name:"%s")', options.dataName) : '',
            noSuffix ? '' : '的'
        );
        result += str;
        return result;
