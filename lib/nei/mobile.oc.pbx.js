...
exports.update = function (projectName, projectPath, updateResPath) {
    ...
    function walk(dir) {
        ...
        list.forEach(function (name) {
            ...
            if (name !== 'Assets.xcassets' && isDir(next + '/')) {
                var dirName = projectName + '/' + next.replace(new RegExp(projectPath + '/'), '');
                var groupKey = createPBXGroupByFullPath(dirName);
                ...
                var groupName = projectName + '/' + next.replace(new RegExp(projectPath + '/'), '');
    ...
    if (updateResPath) {
        ...
        var dirPath = updateResPath + 'Models/';
        createPBXGroupByFullPath(dirPath, true);
        walk(dirPath);
