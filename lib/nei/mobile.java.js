...
pro._build = function (config, options, data) {
    ...
    var params = {
        "packageName": "com.netease.template",
    ...
    if (params.applicationClass !== 'YXApplication') {
        // rename entry class file
        var applicationEntryClass = tplPkgPath + 'application/YXApplication.java';
        var newApplicationEntryClass = util.format(tplPkgPath + 'application/%s.java', params.applicationClass);
        this.emit('debug', {
            data: [params.applicationClass],
