...
class Builder extends EventEmitter {
    ...
    constructor(options) {
        ...
        this.data = {
            args: this.args,
            project: {
                id: options.ds.project.id,
                name: options.ds.project.name,
                description: options.ds.project.description,
                creator: {
                    email: options.ds.project.creator.email,
                    name: options.ds.project.creator.realname
                }
            },
            ds: this.ds
        };
    ...
    buildInterfaceMock() {
        ...
        this.ds.interfaces.forEach((itf)=> {
            ...
            this.ds.interfaceMockRules.push({
                path: url,
